"""
Mask to Walls v8 - Fix for door extension bug:
- Doors now extend to NEAREST wall, not furthest (was causing phantom doors)
- All v7 features: 10px wall_offset, pre-split door filtering
"""
