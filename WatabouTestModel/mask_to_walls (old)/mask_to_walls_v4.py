"""
Mask to Walls v4 - Fix for corner length issue:
- Remove small corner-rounding segments created by erosion (length ≈ wall_offset * sqrt(2))
- Then extend remaining walls via line intersection to meet at true corners
"""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="wall_visualization_v4.png")
