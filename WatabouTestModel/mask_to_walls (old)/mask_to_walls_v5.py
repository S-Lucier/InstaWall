"""
Mask to Walls v5 - Improvements over v4:
- Remove doors that don't connect to walls on both ends (handles partial door masks)
- All v4 features: corner-rounding segment removal, line intersection corners, door extension
"""
...
def calculate_params_from_scale(grid_size_pixels=70, epsilon_override=None):
    ...
    return {
        ...
        'door_extend_max': 50,  # Max pixels to extend doors to find walls
    }
...
def main():
    ...
    parser.add_argument("--output", type=str, default="wall_visualization_v5.png")
    ...
    # Step 8: Re-snap doors to final wall positions
    print("\nStep 8: Snapping doors to final wall positions...")
    all_segments = snap_doors_to_wall_endpoints(all_segments, snap_distance=8)

    # Step 9: Remove disconnected doors (V5 feature)
    print("\nStep 9: Removing disconnected doors...")
    all_segments = remove_disconnected_doors(all_segments, max_distance=10)
