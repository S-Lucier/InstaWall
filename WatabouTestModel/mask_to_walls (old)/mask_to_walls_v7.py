"""
Mask to Walls v7 - Aesthetic improvement over v6:
- Increased wall_offset to 10px for more wall visibility
- All v6 features: pre-split door filtering, corner fixes, door extension
"""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="wall_visualization_v7.png")
