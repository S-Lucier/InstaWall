"""
Mask to Walls v6 - Improvements over v5:
- Filter invalid doors BEFORE wall splitting (prevents orphan wall splits)
- A door is only valid if both endpoints touch/cross wall segments
- All previous features: corner-rounding removal, line intersection corners, door extension
"""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="wall_visualization_v6.png")
